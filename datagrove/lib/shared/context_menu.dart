...
// forked from flutter to attempt better drag interactions for the tab.
...
///
/// When open, the [CupertinoContextMenu2] shows the child, or the widget returned
...
class CupertinoContextMenu2 extends StatefulWidget {
  ...
  /// The widget that can be "opened" with the [CupertinoContextMenu2].
  ///
  /// When the [CupertinoContextMenu2] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [CupertinoContextMenu2] is "closed", this widget acts like a
  ...
  @override
  State<CupertinoContextMenu2> createState() => _CupertinoContextMenu2State();
}

class _CupertinoContextMenu2State extends State<CupertinoContextMenu2>
