...
Future<types.PreviewData> getPreviewData(String text, {String? proxy}) async {
  const previewData = types.PreviewData();

  String? previewDataDescription;
  types.PreviewDataImage? previewDataImage;
  ...
  try {
    ...
    if (imageRegexp.hasMatch(response.headers['content-type'] ?? '')) {
      ...
      previewDataImage = types.PreviewDataImage(
